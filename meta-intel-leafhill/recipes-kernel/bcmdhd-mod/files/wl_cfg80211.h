...
#endif
#if 0
#if defined(WL_CLIENT_SAE) && (LINUX_VERSION_CODE < KERNEL_VERSION(4, 19, 0))
#error "Can not support WL_CLIENT_SAE before kernel 4.19! Contact SparkLAN for more information!"
#endif
#endif
